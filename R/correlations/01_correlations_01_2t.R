##############################################################
# Kendall correlations with windows, cut = 0.1, 2 thresholds #
##############################################################
...
save(alive_kendall_dec,alive_kendall_eq,alive_kendall_rise,dead_kendall_dec,dead_kendall_eq,dead_kendall_rise,nam_kendall_dec,nam_kendall_eq,nam_kendall_rise,eu_kendall_dec,eu_kendall_eq,eu_kendall_rise,neutral_dec,neutral_eq,neutral_rise, file=here("output","correlations","data","cut01_2t.RData"))
...
pdf(file=here("output","correlations","images","cut01_2t","neutral_rise.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.84, y=0.01, labels="tau = 0.1895 (NS)", col="#1E88E5", cex=1.5)
...
# Equilibrium
pdf(file=here("output","correlations","images","cut01_2t","neutral_equilibrium.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.35, y=0.7, labels="tau = 0.7272, p < 0.01", col="#FFC107", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Decline
pdf(file=here("output","correlations","images","cut01_2t","neutral_decline.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.84, y=0.01, labels="tau = 0.3846 (NS)", col="#D81B60", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
pdf(file=here("output","correlations","images","cut01_2t","status_rise.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.84, y=0.1, labels="tau = 0.0513 (NS)", col="#68a83b", cex=1.5)
text(x=0.87, y=0.01, labels="tau = 0.4 (NS)", col="#FF007D", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Equilibrium
pdf(file=here("output","correlations","images","cut01_2t","status_equilibrium.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.35, y=0.7, labels="tau = 0.7143, p < 0.05", col="#68a83b", cex=1.5)
text(x=0.87, y=0.01, labels="tau = 0.6 (NS)", col="#FF007D", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Decline
pdf(file=here("output","correlations","images","cut01_2t","status_decline.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.84, y=0.1, labels="tau = 0.3987 (NS)", col="#68a83b", cex=1.5)
text(x=0.87, y=0.01, labels="tau = 0.4 (NS)", col="#FF007D", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Legend
pdf(file=here("output","correlations","images","cut01_2t","legend_status.pdf"),
    width=8.3,
    height=5.8
)
...
# Rise
pdf(file=here("output","correlations","images","cut01_2t","location_rise.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.84, y=0.1, labels="tau = 0.2889 (NS)", col="#ca8198", cex=1.5)
text(x=0.84, y=0.01, labels="tau = 0.3987 (NS)", col="#008f99", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Equilibrium
pdf(file=here("output","correlations","images","cut01_2t","location_equilibrium.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.4, y=0.8, labels="tau = 0.8571, p < 0.01", col="#ca8198", cex=1.5)
text(x=0.84, y=0.01, labels="tau = 0.6667 (NS)", col="#008f99", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Decline
pdf(file=here("output","correlations","images","cut01_2t","location_decline.pdf"),
    width=8.3,
    height=5.8
)
...
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.84, y=0.01, labels="tau = 0.4285 (NS)", col="#ca8198", cex=1.5)
text(x=0.6, y=0.55, labels="tau = 1, p < 0.05", col="#008f99", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Legend
pdf(file=here("output","correlations","images","cut01_2t","legend_location.pdf"),
    width=8.3,
    height=5.8
)
