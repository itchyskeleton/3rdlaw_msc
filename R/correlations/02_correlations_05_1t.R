#############################################################
# Kendall correlations with windows, cut = 0.5, 1 threshold #
#############################################################
...
save(alive_kendall_dec,alive_kendall_eq,alive_kendall_rise,dead_kendall_dec,dead_kendall_eq,dead_kendall_rise,nam_kendall_dec,nam_kendall_eq,nam_kendall_rise,eu_kendall_dec,eu_kendall_eq,eu_kendall_rise,neutral_dec,neutral_eq,neutral_rise, file=here("output","correlations","data","cut05_1t.RData"))
...
pdf(file=here("output","correlations","images","cut05_1t","neutral_rise.pdf"),
    width=8.3,
    height=5.8
)
...
plot(x=rise$extinction,
     ...
     ylab="",
     ylim=c(0,1),
     main="Expansion (cut=0.5, one threshold)",
     cex.axis=1.5)
#abline(lm(speciation ~ extinction, data=rise), col="#1E88E5", lwd=2)
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.8, y=0.01, labels="tau = 0.1618 (NS)", col="#1E88E5", cex=1.5)
...
pdf(file=here("output","correlations","images","cut05_1t","neutral_eq.pdf"),
    width=8.3,
    height=5.8
)
...
plot(x=eq$extinction,
     ...
     ylab="",
     ylim=c(0,1),
     main="Equilibrium (cut=0.5, one threshold)",
     cex.axis=1.5)
abline(lm(speciation ~ extinction, data=eq), col="#FFC107", lwd=2)
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.35, y=0.7, labels="tau = 0.5686, p < 0.01", col="#FFC107", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
pdf(file=here("output","correlations","images","cut05_1t","neutral_dec.pdf"),
    width=8.3,
    height=5.8
)
...
plot(x=dec$extinction,
     ...
     ylab="",
     ylim=c(0,1),
     main="Decline (cut=0.5, one threshold)",
     cex.axis=1.5)
#abline(lm(speciation ~ extinction, data=dec), col="#D81B60", lwd=2)
abline(0,1,lwd=2, lty=2, col="darkgray")
text(x=0.8, y=0.01, labels="tau = 0.4285 (NS)", col="#D81B60", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
pdf(file=here("output","correlations","images","cut05_1t","status_rise.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.83, y=0.1, labels="tau = -0.1636 (NS)", col="#68a83b", cex=1.5)
text(x=0.84, y=0.01, labels="tau = 0.6190 (NS)", col="#FF007D", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Equilibrium
pdf(file=here("output","correlations","images","cut05_1t","status_equilibrium.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.84, y=0.01, labels="tau = 0.4444 (NS)", col="#FF007D", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Decline
pdf(file=here("output","correlations","images","cut05_1t","status_decline.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.84, y=1, labels="tau = 0.3333 (NS)", col="#68a83b", cex=1.5)
text(x=0.84, y=0.9, labels="tau = 0.5000 (NS)", col="#FF007D", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Legend
pdf(file=here("output","correlations","images","cut05_1t","legend_status.pdf"),
    width=8.3,
    height=5.8
)
...
# Rise
pdf(file=here("output","correlations","images","cut05_1t","location_rise.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.84, y=0.01, labels="tau = 0.2143 (NS)", col="#008f99", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Equilibrium
pdf(file=here("output","correlations","images","cut05_1t","location_equilibrium.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.4, y=0.8, labels="tau = 0.6667, p < 0.01", col="#ca8198", cex=1.5)
text(x=0.8, y=0.5, labels="tau = 0.6, p < 0.05", col="#008f99", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Decline
pdf(file=here("output","correlations","images","cut05_1t","location_decline.pdf"),
    width=8.3,
    height=5.8
)
...
text(x=0.84, y=1, labels="tau = 0.4286 (NS)", col="#ca8198", cex=1.5)
text(x=0.9, y=0.9, labels="tau = 1 (NS)", col="#008f99", cex=1.5)
mtext("Extinction rates", 1, line=3, cex=1.5)
mtext("Speciation rates", 2, line=3, cex=1.5)
...
# Legend
pdf(file=here("output","correlations","images","cut05_1t","legend_location.pdf"),
    width=8.3,
    height=5.8
)
