...
paths <- sub("_RTT_plots.r", "_cut_01_1t.pdf", files)

# 1b. Performing the analyses
for(i in 1:length(files)){
  
  #ETA analyses
  eta(here("data", "pyrate_RTT_plots", files[i]), cut=0.1, two=F, savePlot=T, path=here("output", "eta", "images", "one_threshold", paths[i]))
...
write.table(threshold_rates, file=here("output", "eta", "tables", "1t_threshold_rates_01.txt"), row.names=T, col.names=T, sep="\t")

write.table(rise, file=here("output", "eta", "tables", "1t_mean_rise_01.txt"), row.names=T, col.names=T, sep="\t")

write.table(eq, file=here("output", "eta", "tables", "1t_mean_eq_01.txt"), row.names=T, col.names=T, sep="\t")

write.table(dec, file=here("output", "eta", "tables", "1t_mean_dec_01.txt"), row.names=T, col.names=T, sep="\t")

save(rise, eq, dec, file=here("data", "processed", "corrs_prereqs_cut01_1t.RData"))


# Independent ETA analyses to generate figures ####

#Amphicyonidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Amphicyonidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Amphicyonidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Amphicyonidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Barbourofelidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Barbourofelidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Barbourofelidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Barbourofelidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Canidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Canidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Felidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Felidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Felidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Felidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Herpestidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Herpestidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Hyaenidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Hyaenidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Mephitidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Mephitidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Mustelidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Mustelidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Mustelidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Mustelidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Nimravidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Nimravidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Nimravidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Nimravidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Palaeogalidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Palaeogalidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Palaeogalidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Palaeogalidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Percrocutidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Percrocutidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Procyonidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Procyonidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Ursidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Ursidae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Ursidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Ursidae_NA_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
#Viverridae_EU
eta(file=here("data", "pyrate_RTT_plots", "Viverridae_EU_RTT_plots.R"), cut=0.1, two=F)
eta.means()
...
plot(x=rise$extinction,
     ...
     ylim=c(0,1),
     main="Expansion by locality (cut=0.1, two=F)")
...
plot(x=eq$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Equilibrium (cut=0.1, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=rise$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Expansion by status (cut=0.1, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=eq$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Equilibrium by status (cut=0.1, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=dec$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Decline by status (cut=0.1, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
