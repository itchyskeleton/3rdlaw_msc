...
paths <- sub("_RTT_plots.r", "_cut_05_1t.pdf", files)

# 1b. Performing the analyses
for(i in 1:length(files)){
  
  #ETA analyses
  eta(here("data", "pyrate_RTT_plots", files[i]), cut=0.5, two=F, savePlot=T, path=here("output", "eta", "images", "one_threshold", paths[i]))
...
write.table(threshold_rates, file=here("output", "eta", "tables", "1t_threshold_rates_05.txt"), row.names=T, col.names=T, sep="\t")

write.table(rise, file=here("output", "eta", "tables", "1t_mean_rise_05.txt"), row.names=T, col.names=T, sep="\t")

write.table(eq, file=here("output", "eta", "tables", "1t_mean_eq_05.txt"), row.names=T, col.names=T, sep="\t")

write.table(dec, file=here("output", "eta", "tables", "1t_mean_dec_05.txt"), row.names=T, col.names=T, sep="\t")

save(rise, eq, dec, file=here("data", "processed", "corrs_prereqs_cut05_1t.RData"))


# Independent ETA analyses to generate figures ####

#Amphicyonidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Amphicyonidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Amphicyonidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Amphicyonidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Barbourofelidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Barbourofelidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Barbourofelidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Barbourofelidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Canidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Canidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Felidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Felidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Felidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Felidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Herpestidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Herpestidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Hyaenidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Hyaenidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Mephitidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Mephitidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Mustelidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Mustelidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Mustelidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Mustelidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Nimravidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Nimravidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Nimravidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Nimravidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Palaeogalidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Palaeogalidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Palaeogalidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Palaeogalidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Percrocutidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Percrocutidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Procyonidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Procyonidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Ursidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Ursidae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Ursidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Ursidae_NA_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
#Viverridae_EU
eta(file=here("data", "pyrate_RTT_plots", "Viverridae_EU_RTT_plots.R"), cut=0.5, two=F)
eta.means()
...
plot(x=rise$extinction,
     ...
     ylim=c(0,1),
     main="Expansion by locality (cut=0.5, two=F)")
...
text(x=0.5, y=0.85, labels="r² = -0.005411", col=alpha("#008f99",0.8))
...
plot(x=eq$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Equilibrium (cut=0.5, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
na_spearmaneq_0.5 <- cor.test(x=eq_na$extinction, y=eq_na$speciation, method="spearman", alternative="two.sided") # rho = 0.9272727, p = 0.0005302
...
na_spearmandec_0.5 <- cor.test(x=dec_na$extinction, y=dec_na$speciation, method="spearman", alternative="two.sided") # rho = 0.8928571 , p = 0.0523
...
plot(x=eq$extinction,
     ...
     main="Equilibrium (cut=0.5, two=F)")
#abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
text(x=0.73, y=0.15, labels="rho = 0.8881, p < 0.05", col="#ca8198", cex=1.2)
text(x=0.73, y=0.03, labels="rho = 0.9272, p < 0.05", col="#008f99", cex=1.2)
...
text(x=0.73, y=0.05, labels="rho = 0.8929, p < 0.05", col="#008f99", cex=1.2)
...
eu_kendalleq_0.5 <- cor.test(x=eq_eu$extinction, y=eq_eu$speciation, method="kendall", alternative="two.sided") # tau = 0.7878788, p = 0.0005074
...
na_kendalldec_0.5 <- cor.test(x=dec_na$extinction, y=dec_na$speciation, method="kendall", alternative="two.sided") # tau = 0.8095238, p = 0.05071
...
plot(x=eq$extinction,
     ...
     main="Equilibrium (cut=0.5, two=F)")
#abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
text(x=0.73, y=0.15, labels="tau = 0.7879, p < 0.05", col="#ca8198", cex=1.2)
text(x=0.73, y=0.03, labels="tau = 0.7778, p < 0.05", col="#008f99", cex=1.2)
...
text(x=0.73, y=0.05, labels="tau = 0.8095, p < 0.05", col="#008f99", cex=1.2)
...
plot(x=rise$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Expansion by status (cut=0.5, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=eq$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Equilibrium by status (cut=0.5, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=dec$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Decline by status (cut=0.5, two=F)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
alive_spearman_eq_0.5 <- cor.test(x=eq_alive$extinction, y=eq_alive$speciation, method="spearman", alternative="two.sided") # rho = 0.8905099, p-value < 2.2e-16
...
plot(x=eq$extinction,
     ...
     main="Equilibrium (cut=0.5, two=F)")
#abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
text(x=0.73, y=0.15, labels="rho = 0.2857, p < 0.05", col="#68a83b", cex=1.2)
text(x=0.73, y=0.03, labels="rho = 0.9333, p < 0.05", col="#FF007D", cex=1.2)
...
text(x=0.73, y=0.05, labels="rho = 0.75, p < 0.05", col="#FF007D", cex=1.2)
...
alive_kendall_eq_0.5 <- cor.test(x=eq_alive$extinction, y=eq_alive$speciation, method="kendall", alternative="two.sided") # tau = 0.7435897 , p-value = 0.0005453
...
plot(x=eq$extinction,
     ...
     main="Equilibrium (cut=0.5, two=F)")
#abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
text(x=0.73, y=0.15, labels="tau = 0.7436, p < 0.05", col="#68a83b", cex=1.2)
text(x=0.73, y=0.03, labels="tau = 0.8333, p < 0.05", col="#FF007D", cex=1.2)
...
text(x=0.73, y=0.05, labels="tau = 0.5555, p < 0.05", col="#FF007D", cex=1.2)
