...
paths <- sub("_RTT_plots.r", "_cut_09_2t.pdf", files)

# 1b. Performing the analyses
for(i in 1:length(files)){
  
  #ETA analyses
  eta(here("data", "pyrate_RTT_plots", files[i]), cut=0.9, savePlot=T, path=here("output", "eta", "images", "two_thresholds", paths[i]))
...
for(i in 1:length(files)){
  ...
  #ETA analyses
  eta(here("data", "pyrate_RTT_plots",  files[i]), cut=0.9, savePlot=F, two=T)
...
write.table(threshold_rates, file=here("output", "eta", "tables", "2t_threshold_rates_09.txt"), row.names=T, col.names=T, sep="\t")

write.table(rise, file=here("output", "eta", "tables", "2t_mean_rise_09.txt"), row.names=T, col.names=T, sep="\t")

write.table(eq, file=here("output", "eta", "tables", "2t_mean_eq_09.txt"), row.names=T, col.names=T, sep="\t")

write.table(dec, file=here("output", "eta", "tables", "2t_mean_dec_09.txt"), row.names=T, col.names=T, sep="\t")

save(rise, eq, dec, file=here("data", "processed", "corrs_prereqs_cut09_2t.RData"))


# Independent ETA analyses to generate figures ####

#Amphicyonidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Amphicyonidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Amphicyonidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Amphicyonidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Barbourofelidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Barbourofelidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Barbourofelidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Barbourofelidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Canidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Canidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Felidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Felidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Felidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Felidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Herpestidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Herpestidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Hyaenidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Hyaenidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Mephitidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Mephitidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Mustelidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Mustelidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Mustelidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Mustelidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Nimravidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Nimravidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Nimravidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Nimravidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Palaeogalidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Palaeogalidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Palaeogalidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Palaeogalidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Percrocutidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Percrocutidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Procyonidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Procyonidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Ursidae_EU
eta(file=here("data", "pyrate_RTT_plots", "Ursidae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
#Ursidae_NA
eta(file=here("data", "pyrate_RTT_plots", "Ursidae_NA_RTT_plots.R"), cut=0.9)
eta.means()
...
#Viverridae_EU
eta(file=here("data", "pyrate_RTT_plots", "Viverridae_EU_RTT_plots.R"), cut=0.9)
eta.means()
...
plot(x=rise$extinction,
     ...
     ylim=c(0,1),
     main="Expansion by locality (cut=0.9)")
...
plot(x=rise$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Expansion by status (cut=0.9)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=eq$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Equilibrium by status (cut=0.9)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
...
plot(x=dec$extinction,
     ...
     ylab="Speciation rates",
     ylim=c(0,1),
     main="Decline by status (cut=0.9)")
abline(a=0, b=1, lwd=2, col=alpha("black",0.3), lty=2)
